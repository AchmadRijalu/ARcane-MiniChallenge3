...
open class MultipeerSession: NSObject {
	...
	public let receivedDataHandler: (Data, MCPeerID) -> Void
	public let peerJoinedHandler: (MCPeerID) -> Void
	public let peerLeftHandler: (MCPeerID) -> Void
	public let peerDiscoveredHandler: (MCPeerID) -> Bool
